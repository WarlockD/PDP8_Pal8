...
CodeEditor::~CodeEditor() {
    if(highlighter) { delete highlighter; highlighter = nullptr; }
}

int CodeEditor::lineNumberAreaWidth()
{
    int digits = 1;
    int max = qMax(100, blockCount()); // set width of line numbers for 3 digits
    while (max >= 10) {
        max /= 10;
        ++digits;
    }
...
void CodeEditor::highlightCurrentLine()
{
 ...
 void CodeEditor::assemblyAreaPaintEvent(QPaintEvent *event) {
